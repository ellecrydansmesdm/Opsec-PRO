              ...
              return (
                <button 
                  ...
                  style={{ 
                    ...
                    background: isSelected ? `color-mix(in srgb, ${house.color} 12%, transparent)` : 'rgba(0,0,0,0.2)',
                    border: `1px solid ${isSelected ? house.color : 'rgba(255,255,255,0.06)'}`,
                    boxShadow: isSelected ? `0 0 16px color-mix(in srgb, ${house.color} 25%, transparent)` : 'none',
                ...
                >
                  <div style={{
                    ...
                    height: '32px',
                    borderRadius: '10px',
                    background: `color-mix(in srgb, ${house.color} 15%, transparent)`,
                    border: `1px solid color-mix(in srgb, ${house.color} 30%, transparent)`,
                    boxShadow: `0 0 12px color-mix(in srgb, ${house.color} 20%, transparent)`,
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center'
                  }}>
                    <HouseIcon size={16} color={house.color} />
                  </div>
                  <span style={{ fontSize: '10px', fontWeight: '900', color: isSelected ? house.color : '#fff', letterSpacing: '0.5px' }}>{house.name.toUpperCase()}</span>
                  {isSelected && (
                    <div style={{ position: 'absolute', top: '6px', right: '6px' }}>
                      <CheckCircle2 size={12} color={house.color} />
                    </div>
                  )}
                </button>
              );
