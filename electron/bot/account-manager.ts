...
import { encryptToken, decryptToken, saveSettings, getSettings } from '../utils/settings';
...
export class AccountManager {
    ...
    public addAccountsBatch(newAccounts: Account[]) {
    ...
    private save() {
        try {
            ...
            saveSettings({
                ...
                lastActiveAccountId: selected?.id || undefined
            });
        } catch (e) {
